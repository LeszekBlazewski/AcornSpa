...
@NgModule({
  ...
  declarations: [FooterComponent, NavbarComponent, SidebarComponent, BotCardComponent, BotAccountListComponent, ConfigModalComponent, ToastrNotificationComponent, AccountsModalComponent, AccountEditModalComponent],
  ...
  entryComponents: [ConfigModalComponent, ToastrNotificationComponent, AccountsModalComponent, AccountEditModalComponent]
})
